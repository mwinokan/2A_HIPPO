...
cp -v $HOME2/2A_HIPPO/A71EV2A_P3only_20241211/aligned_files/$KEY/*_apo-desolv.pdb templates/
...
echo --metadata "/opt/xchem-fragalysis-2/maxwin/2A_HIPPO/A71EV2A_P3only_20241211/metadata.csv"
...
syndirella \
	...
	--metadata "/opt/xchem-fragalysis-2/maxwin/2A_HIPPO/A71EV2A_P3only_20241211/metadata.csv" \
